    ...
    try {
        uploadCategory.single('img')(req, res, async function (err) {
            ...
            if (req.file) {
                ...
                const serverIp = process.env.SERVER_IP; // Adresse IP définie dans .env
                const port = process.env.PORT; // Port défini dans .env
                imageUrl = `http://${serverIp}:${port}/image/category/${req.file.filename}`;
